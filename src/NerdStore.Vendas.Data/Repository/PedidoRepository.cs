...
namespace NerdStore.Vendas.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        {
            var pedido = await _context.Pedidos.FirstOrDefaultAsync(p => p.ClienteId == clienteId && p.PedidoStatus == EPedidoStatus.Rascunho);
        ...
        public async Task<Voucher> ObterVoucherPorId(string codigo)
        {
